...
public class daysofamonth {
    ...
    public static void main(String[] args){
        ...
        String[] days_31={"January","March","May","July","August","October","December"
        ,"Jan.","Mar.","Aug.","Oct.","Dec.","Jan","Mar","May","Jul","Aug","Oct","Dec",
        "1","3","5","7","8","10","12"};
        
        String[] days_30={"April","June","September","November",
        ...
        if (Arrays.asList(days_31).contains(month)) {
            System.out.println("This month has 31 day");
            
        }if (Arrays.asList(days_30).contains(month)){
